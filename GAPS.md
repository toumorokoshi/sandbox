...
- **Rust Bazel Integration**: The newly added `io_benchmark` Rust package is built and tested with Cargo. If the repository standardizes on Bazel for all languages, `rules_rust` can be added to `MODULE.bazel` to compile Rust targets hermetically.
